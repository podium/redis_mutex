...
making it easier for developers to [contribute to Redis Mutex](#pull-requests).
...
your Operating System, as well as your Erlang, Elixir and Redis Mutex versions. Please provide steps to
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/redis_mutex

   # Navigate to the newly cloned directory
   cd redis_mutex

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/podium/redis_mutex
   ```
